...
export const teal = createPaletteChannel(themeConfig.palette.teal);
export const blue = createPaletteChannel(themeConfig.palette.blue);
export const emerald = createPaletteChannel(themeConfig.palette.emerald);
export const red = createPaletteChannel(themeConfig.palette.red);

// Text color
export const text = {
  light: createPaletteChannel({ primary: grey[800], secondary: grey[600], disabled: grey[500] }),
  dark: createPaletteChannel({ primary: grey[100], secondary: grey[500], disabled: grey[600] }),
};

// Background color
export const background = {
  light: createPaletteChannel({ paper: '#FFFFFF', default: '#FFFFFF', neutral: grey[200] }),
  dark: createPaletteChannel({ paper: grey[800], default: '#000000', neutral: '#28323D' }),
};
