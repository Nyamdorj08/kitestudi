...
export const SOLO_VISUALREADWRITEKINESTHETIC: VisualData = {
  ...
  mainType:
    'Орон зайн / харааны + Бичгэн / уншиж бичих + Бие махбодын / хөдөлгөөнөөр + Ганцаарчилсан',
  chips: [
    {
  ...
  generalExamples: {
    examples: [
      ...
      {
        topic: 'Шинэ программ',
        text: 'Excel сурахдаа эхний өдөртөө “Монголын гэр бүлийн төсөв” гэж жижиг хүснэгт зохиогоод, ямар багана (огноо, орлого, зарлага, төрөл) хэрэгтэйг цаасан дээрээ гаргах. Дараа нь Excel дээр яг тэр бүтцийг хийх – интерфэйсийг бас гараар зур, ямар таб дээр юу байдгийг тэмдэглэ.',
      },
      {
        topic: 'Хоол хийх',
